 ...
 *
 *=========================================================================*/
#ifndef __itkCatheterMatchRigidTransformOptimizer_h
#define __itkCatheterMatchRigidTransformOptimizer_h
...
namespace itk
{
/** \class CatheterMatchRigidTransformOptimizer
 * \brief Implement a gradient descent optimizer for the VersorRigid3DTransform
 * parameter space.
 *
 * CatheterMatchRigidTransformOptimizer is a variant of the gradient descent
...
public:
  ...
  typedef CatheterMatchRigidTransformOptimizer         Self;
  ...
  itkTypeMacro(CatheterMatchRigidTransformOptimizer,
...
protected:
  CatheterMatchRigidTransformOptimizer() {}
  virtual ~CatheterMatchRigidTransformOptimizer() {}

private:
  CatheterMatchRigidTransformOptimizer(const Self &); //purposely not implemented
