 ...
 *
 *=========================================================================*/
#ifndef _itkCatheterMatchRigidTransformOptimizer_hxx
#define _itkCatheterMatchRigidTransformOptimizer_hxx
                    ...
                    const DerivativeType & transformedGradient)
{
  ...
  for ( unsigned int k = 0; k < SpaceDimension; k++ )
    {
    newParameters[k] = currentPosition[k] + transformedGradient[k]/scales[k] * factor;
    }
